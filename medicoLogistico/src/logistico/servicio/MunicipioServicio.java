...
public class MunicipioServicio implements Serializable {
	...
	public void guardar(String descripcion, int departamentoId, int usuarioConectado) {
		Municipio municipio = new Municipio(descripcion, departamentoId, usuarioConectado);
		try {
